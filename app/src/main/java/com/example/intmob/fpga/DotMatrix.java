...
public class DotMatrix extends Activity {

    public static final String Z20 = "00000000000000000000";
    ...
    public void startf(String value){
    ...
    class BackThread extends DaemonThread{
        private int doStart(){
            // check string length
            if (value.length() > 50){
                Log.e("DotMatrix", "Max input length is 50.");
                start = false;
                restart = false;
                return 0;
            }else{
                ...
                for(i = 0;i<value.length();i++){
                    ...
                    if(ch < 32 || ch > 126){
                        Log.e("DotMatrix", "Unsupported character.");
                        start = false;
                        restart = false;
                        break;
                    }
